...
import { useEditSuppliers } from "../../../hooks/user/suppliers/useEditSuppliers";
import Loading from "../../../features/common/Loading";
import Button from "../../../features/common/Button";
import FileUpload from "../../../features/common/FileUpload";

const SuppliersEdit = () => {
  const { formData, handleChange, handleSubmit, handleCancel, handleImageChange, errors, loading, buttonLoading} = useEditSuppliers();
