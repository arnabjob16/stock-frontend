...
import { useEditSalesmans } from "../../../hooks/user/salesmans/useEditSalesmans";
import Loading from "../../../features/common/Loading";
import Button from "../../../features/common/Button";
import FileUpload from "../../../features/common/FileUpload";

const SalesmansEdit = () => {
  const { formData, handleChange, handleSubmit, handleCancel, handleImageChange, errors, loading, buttonLoading} = useEditSalesmans();
